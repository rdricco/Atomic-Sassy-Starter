...
gulp.task('watch', function() {
  ...
  gulp.watch(bases.app + 'pages/*', ['nunjucks']);
  gulp.watch(bases.app + 'templates/**', ['nunjucks']);
...
//   runSequence('clean:dist', 'browser-sync', 'js-app', 'js-libs', 'imagemin', 'nunjucks', 'minify-html', 'styles', 'themes', 'copy', 'watch', done);
// });
...
gulp.task('build', function(done) {
  runSequence('clean:dist', 'js-app', 'js-libs', 'imagemin', 'minify-html', 'nunjucks', 'styles', 'copy', done);
});
